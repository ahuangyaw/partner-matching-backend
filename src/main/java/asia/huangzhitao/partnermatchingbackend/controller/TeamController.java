...
import asia.huangzhitao.partnermatchingbackend.model.request.UserLoginRequest;
import asia.huangzhitao.partnermatchingbackend.model.request.UserRegisterRequest;
...
public class TeamContorlle {
    ...
    public BaseResponse<Page<User>> recommendUsers(long pageSize,long pageNum,HttpServletRequest request) {
        ...
        //查询缓存
        String redisKey = String.format("xiaohuang:user:recommend:%s", userLogin.getId());
        ...
        //写缓存
        try {
            valueOperations.set(redisKey,userPage,360, TimeUnit.SECONDS);//设置缓存超时360s
        } catch (Exception e) {
