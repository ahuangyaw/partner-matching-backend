package asia.huangzhitao.partnermatchingbackend.service.impl;
...
import asia.huangzhitao.partnermatchingbackend.mapper.UserMapper;
...
//        return userList.parallelStream().filter ， parallelStream 并发流,要用线程池,默认是用Java1.7的
    ...
    public int updateUser(User user,User userLogin) {
        ...
        //查询，如果是管理员，则可以修改全部用户，否则只能修改自己的信息
        //判断权限，仅管理员和自己可修改
